 ...
 * @author jomel
 */
public class AdminBegin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        closurebtn = new javax.swing.JButton();
        ...
        add(afibtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 340, 180, 40));

        closurebtn.setBackground(new java.awt.Color(57, 45, 82));
        closurebtn.setFont(new java.awt.Font("Sitka Text", 0, 12)); // NOI18N
        closurebtn.setForeground(new java.awt.Color(255, 255, 255));
        closurebtn.setText("REALIZAR CIERRE");
        closurebtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                closurebtnActionPerformed(evt);
            }
        });
        add(closurebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, 140, 40));
        ...
        add(divbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 160, 40));
        ...
        add(cuentabtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 340, 190, 40));
    ...
    private void closurebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closurebtnActionPerformed
        BackEnd.Main.db.setClosure(BackEnd.Main.logged.getUsername());
    }//GEN-LAST:event_closurebtnActionPerformed
    ...
    private javax.swing.JButton closurebtn;
